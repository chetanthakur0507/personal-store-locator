  ...
  return (
    <section id="store" className="mx-auto max-w-6xl px-6 py-10">
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-3xl bg-white p-5 shadow-sm border border-rose-100">
          <img
            src="https://images.unsplash.com/photo-1601600576337-c1d8a0d1373f?q=80&w=1200&auto=format&fit=crop"
            alt="Store shelves"
        ...
        <div className="rounded-3xl bg-white p-6 shadow-sm border border-rose-100">
          ...
          <div className="mt-5 grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-2xl bg-rose-50 p-4">
              <p className="font-semibold text-gray-900">30+ Aisles</p>
              <p className="text-xs text-gray-600">Well-organized sections</p>
            </div>
            <div className="rounded-2xl bg-rose-50 p-4">
              <p className="font-semibold text-gray-900">5k+ Items</p>
              <p className="text-xs text-gray-600">Always in stock</p>
            </div>
            <div className="rounded-2xl bg-rose-50 p-4">
              <p className="font-semibold text-gray-900">Fast Billing</p>
